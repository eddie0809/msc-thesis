...
centered, draw=black, fill=gray!20, font=\footnotesize]
\tikzstyle{measx} = [rectangle, rounded corners, minimum width=1cm, minimum height=1cm,text centered, draw=black]
