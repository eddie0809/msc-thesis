...
\cite{liMeasurementdrivenEntanglementTransition2019}.
%Following the suggestion in Ref.  \cite{skinnerLectureNotesIntroduction2023},
%we invite the interested reader to consult the review papers
%\cite{fisherRandomQuantumCircuits2023,potterEntanglementDynamicsHybrid2021},
%as well as the authors first introduction to the field, Ref.
%\cite{liMeasurementdrivenEntanglementTransition2019}
...
of correlations,
%To this end, it can prove useful to think of entanglement as correlations,
...
\subsection{Random circuits}\label{sec:randomcircuits}
...
\begin{figure}[t]
  ...
  \begin{subfigure}{0.42\textwidth}
    \input{fig/tikz/randomcircuit.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.42\textwidth}
    \input{fig/tikz/brickwork.tex}
  \end{subfigure}
...
The original problem of the MIPT concerned itself with the circuit of the form depicted in
...
There are three concluding notes to this section we do not want to fail to
...
In this subsection, we briefly review the classical Ising model, following Refs.
...
Secondly, we observe that the entangling phase now also has an area-law scaling
...
Not that this has not been tried. See Refs.
...
%This requires 
%
%However, when sampling over many 
%entanglement of pure states
%
%Especially limiting in
%the experimental observation is 
%
%To make do with them, we employ classical
%computer simulations. That is, we perform \enquote{numerical experiments}. While
%traditional experiments still serve as the sole proprietor of claim to
%ontology, simulations can play a supporting role.
%
