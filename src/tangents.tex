...
At the end of the day, however, it is only an emulation of what is happening in
...
%radical conclusion we might draw from this is that a 
%simulation that models something not translateable to an experimental setup
%tells me about as much about the system it is supposed to model as the
%following \texttt{C} code:
\begin{verbatim}
#include <stdio.h>
...
I claim that this, albeit a strawman argument, is short-sighted. The extrapolation from
